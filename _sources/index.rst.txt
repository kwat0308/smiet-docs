...
Examples 
--------
See :doc:`here <minimal_example>` for a minimal example of how to use the package. You can also look at `smiet-examples <https://gitlab.iap.kit.edu/kwatanabe/smiet-examples.git>`_ for more complete examples.
